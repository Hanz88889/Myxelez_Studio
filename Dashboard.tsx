        ...
        <Reveal delay={0.05}>
          <Card hover className="p-5 flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-mist mt-1">2,880 CR</p>
              <p className="text-[11.5px] text-ash mt-1 flex items-center gap-1"><Clock size={11} /> Tidak ada masa berlaku</p>
              <button type="button" onClick={() => navigate('/studio/settings?tab=topup')} className="text-[11.5px] text-silver hover:text-mist mt-1.5 flex items-center gap-1 cursor-pointer">Top up <ArrowUpRight size={11} /></button>
            </div>
          </Card>
        </Reveal>
        <Reveal delay={0.1}>
