...
/* ─── Feature bento ─── */
const TOOLS = [
  { icon: ImageIcon, name: 'Image Generation', desc: 'Photon v2 renders gallery-grade stills with true-to-prompt fidelity.', img: 'public/media/gen-portrait.jpg', big: true },
