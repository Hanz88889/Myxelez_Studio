...
export const PLANS: CreditPackage[] = [
  ...
  {
    id: 'creator', name: 'Creator Pack', price: 149000, credits: 1000, bonus: 200, tagline: 'For serious creators',
    features: ['1,000 + 200 bonus CR', 'All engines incl. Motion v1', 'Up to 4K + upscale', 'Face Swap & BG Removal', 'Creative Resources suite', 'Commercial license', 'Priority queue'],
    cta: 'Top up now', featured: true,
  },
  {
    id: 'studio', name: 'Studio Pack', price: 499000, credits: 3500, bonus: 900, tagline: 'For teams & pipelines',
    features: ['3,500 + 900 bonus CR', 'Everything in Creator', '5 team seats', 'API access & webhooks', 'Brand Kit + presets', 'Workflow automation', 'Dedicated support'],
    cta: 'Top up now', featured: false,
  },
]
