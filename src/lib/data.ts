...
export const GALLERY: GalleryItem[] = [
  { id: 'g1', src: '/media/Chrome-Reverie.jpg', title: 'Chrome Reverie', prompt: 'Cinematic portrait of a woman draped in liquid silver light, futuristic noir, 85mm f/1.4, volumetric haze', model: 'Flux 1SR pro', style: 'Neo Noir', ratio: '3:4', seed: 84120031, time: '12m ago', liked: true },
  { id: 'g2', src: '/media/Neon-Rain-District.jpg', title: 'Neon Rain District', prompt: 'Futuristic megacity in the rain, neon signage reflecting on wet streets, aerial light trails, moody silver-blue grade', model: 'FLUX.1', style: 'Neo Tokyo', ratio: '16:9', seed: 519902147, time: '38m ago', liked: false },
  { id: 'g3', src: '/media/Void-Walker.jpg', title: 'Void Walker', prompt: 'Astronaut in a glossy obsidian suit standing in dense fog, dramatic rim light, minimal dark backdrop, film still', model: 'Nano Banana Pro', style: 'Cinematic', ratio: '3:4', seed: 277441890, time: '1h ago', liked: true },
  { id: 'g4', src: '/media/Argent-Couture.jpg', title: 'Argent Couture', prompt: 'High fashion editorial, sculptural metallic silver garment, dramatic studio lighting on charcoal backdrop', model: 'Flux.2 pro', style: 'Editorial', ratio: '3:4', seed: 902114556, time: '2h ago', liked: false },
  { id: 'g5', src: '/media/Monolith.jpg', title: 'Monolith I', prompt: 'Brutalist concrete monolith at dusk, single beam of light cutting through fog, minimalist composition', model: 'Seedream 5.0', style: 'Architect', ratio: '16:9', seed: 668120044, time: '3h ago', liked: true },
  { id: 'g6', src: '/media/Obsidian.jpg', title: 'GT Obsidian', prompt: 'Luxury grand tourer in a dark studio, razor rim lighting, carbon details, reflective black floor', model: 'flux flora', style: 'Product', ratio: '16:9', seed: 340998172, time: '5h ago', liked: false },
  { id: 'g7', src: '/media/Liquid-Argentum.jpg', title: 'Liquid Argentum', prompt: 'Abstract liquid chrome waves frozen mid-motion, mirror reflections, macro detail, dark gradient backdrop', model: 'Z image turbo', style: 'Abstract', ratio: '16:9', seed: 710228493, time: '6h ago', liked: true },
  { id: 'g8', src: '/media/Mist-Protocol.jpg', title: 'Mist Protocol', prompt: 'Dark conifer forest swallowed by fog, blue hour, a lonely road vanishing into mist, cinematic grade', model: 'Grock imagine', style: 'Cinematic', ratio: '16:9', seed: 153667820, time: '8h ago', liked: false },
  { id: 'g9', src: '/media/Orchid-Spectre.jpg', title: 'Orchid Spectre', prompt: 'Macro translucent white orchid on pure black, dew droplets, dramatic side light, dark luxury aesthetic', model: 'Nano banana pro', style: 'Macro', ratio: '1:1', seed: 990443215, time: '1d ago', liked: true },
  { id: 'g10', src: '/media/Nocturne-Tide.jpg', title: 'Nocturne Tide', prompt: 'Dark ocean wave curling at night, moonlit silver highlights on black water, cinematic spray detail', model: 'Ideogram v3', style: 'Cinematic', ratio: '16:9', seed: 480112736, time: '1d ago', liked: false },
  { id: 'g11', src: '/media/Refraction.jpg', title: 'Refraction Study 04', prompt: 'Glass prism refracting a beam of white light, soft spectral dispersion, floating dust, macro cinematic', model: 'Flux 2', style: 'Abstract', ratio: '16:9', seed: 611550924, time: '2d ago', liked: false },
  { id: 'g12', src: '/media/Drift.jpg', title: 'Dune Drift', prompt: 'Aerial desert dunes at blue hour, rippled sand patterns, lone figure walking, silver-blue moonlight', model: 'Seedream V.4', style: 'Minimal', ratio: '16:9', seed: 208774191, time: '2d ago', liked: true },
]

export const MODELS = [
  { id: 'Nano Banana', name: 'Banana V2', desc: 'Flagship image engine · best quality', badge: 'Pro' },
  { id: 'GPT image', name: 'GPT-Image 2', desc: 'Draft iterations · 4× faster', badge: 'Fast' },
  { id: 'Wan', name: 'Wan 2.2', desc: 'Experimental detail & realism', badge: 'Lab' },
  { id: 'Seedance', name: 'Seedance 2.0', desc: 'Cinematic video synthesis', badge: 'Video' },
...
export const COLLECTIONS = [
  { id: 'c1', name: 'Silver Studies', covers: ['/media/chrome.jpg', '/media/gen-prism.jpg', '/media/gen-portrait.jpg'], count: 64 },
  { id: 'c2', name: 'Dark Worlds', covers: ['/media/city.jpg', '/media/gen-forest.jpg', '/media/gen-astro.jpg'], count: 112 },
  { id: 'c3', name: 'Product Heroes', covers: ['/media/product.jpg', '/media/product-bg.jpg', '/media/gen-flower.jpg'], count: 38 },
  { id: 'c4', name: 'Horizon Lines', covers: ['/media/desert.jpg', '/media/gen-ocean.jpg', '/media/gen-arch.jpg'], count: 27 },
]
...
export const TEMPLATES = [
  { id: 't1', name: 'Cinematic Poster', desc: 'Key art layout with title safe zones', cover: '/media/poster.jpg', category: 'Film', ratio: '2:3' },
  ...
  { id: 't3', name: 'Editorial Spread', desc: 'Fashion lookbook double page', cover: '/media/fashion3.jpg', category: 'Print', ratio: '3:2' },
  { id: 't4', name: 'Album Cover', desc: 'Square sleeve with type overlay zone', cover: '/media/square.jpg', category: 'Music', ratio: '1:1' },
  { id: 't5', name: 'Story Sequence', desc: '9:16 vertical social story set', cover: '/media/story.jpg', category: 'Social', ratio: '9:16' },
  { id: 't6', name: 'Architectural Board', desc: 'Presentation board with elevations', cover: '/media/elevations.jpg', category: 'ArchViz', ratio: '16:9' },
]
...
export const ASSETS = [
  { id: 'a1', name: 'hero-keyart-final.png', type: 'Image', size: '18.2 MB', src: '/media/keyart.jpg', updated: '2h ago' },
  { id: 'a2', name: 'gt-obsidian-16x9.png', type: 'Image', size: '11.4 MB', src: '/media/obsidian2.jpg', updated: '5h ago' },
  { id: 'a3', name: 'hero-loop.mp4', type: 'Video', size: '24.8 MB', src: '/media/hero-loop.mp4', updated: '1d ago' },
  { id: 'a4', name: 'orchid-spectre.tif', type: 'Image', size: '42.1 MB', src: '/media/flower.jpg', updated: '1d ago' },
  { id: 'a5', name: 'brand-guidelines.pdf', type: 'Document', size: '6.3 MB', src: '', updated: '3d ago' },
  { id: 'a6', name: 'myxelez-wordmark.svg', type: 'Vector', size: '84 KB', src: '/media/logo.png', updated: '4d ago' },
...
export const MOODBOARDS = [
  { id: 'm1', name: 'Liquid Argentum', images: ['/media/liquid-1.jpg', '/media/liquid-2.jpg', '/media/liquid-3.jpg', '/media/liquid-4.jpg', '/media/liquid-5.jpg'], count: 24 },
  { id: 'm2', name: 'After Midnight', images: ['/media/after-1.jpg', '/media/after-2.jpg', '/media/after-3.jpg', '/media/after-4.jpg'], count: 31 },
  { id: 'm3', name: 'Silent Forms', images: ['/media/silent-1.jpg', '/media/silent-2.jpg', '/media/silent-3.jpg', '/media/silent-4.jpg'], count: 18 },
]
...
export const NOTIFICATIONS = [
  ...
  { id: 'n3', title: 'Top up successful', desc: '2,000 CR added to your balance.', time: '3h ago', unread: true, kind: 'billing' },
...
/* ─── Settings: Sessions, Connected accounts, API keys ─── */
export const SESSIONS = [
  { id: 'se1', device: 'Chrome · Windows 11', location: 'Kediri, Indonesia', last: 'Active now', current: true },
  { id: 'se2', device: 'Myxelez App · Android', location: 'Kediri, Indonesia', last: '2h ago', current: false },
  { id: 'se3', device: 'Safari · macOS', location: 'Jakarta, Indonesia', last: '1d ago', current: false },
]

export const CONNECTED = [
  { id: 'github', name: 'GitHub', desc: 'Sync prompt presets & version history', connected: true },
  { id: 'gdrive', name: 'Google Drive', desc: 'Auto-backup renders & projects', connected: false },
  { id: 'slack', name: 'Slack', desc: 'Batch-render notifications', connected: false },
  { id: 'zapier', name: 'Zapier', desc: 'Automate workflows with 6,000+ apps', connected: true },
]

export const API_KEYS_SEED = [
  { id: 'k1', name: 'Production', prefix: 'myx_live_', created: '12 Feb 2026', last: '4m ago', scopes: 'read:write' },
  { id: 'k2', name: 'Staging', prefix: 'myx_test_', created: '2 Feb 2026', last: '3d ago', scopes: 'read:write' },
]

/* ─── Top-up & transaction history (pay-as-you-go) ─── */
export const CREDIT_HISTORY = [
  { id: 'ch1', action: 'Top up — Studio Pack', date: '11 Feb 2026', credits: 5000 },
  { id: 'ch2', action: 'Generated batch ×4 — Chrome Reverie', date: '11 Feb 2026', credits: -4 },
  { id: 'ch3', action: 'Upscaled to 4K — GT Obsidian', date: '10 Feb 2026', credits: -4 },
  { id: 'ch4', action: 'Motion render 8s — Nocturne Tide', date: '9 Feb 2026', credits: -40 },
  { id: 'ch5', action: 'Top up — Creator Pack', date: '3 Feb 2026', credits: 1200 },
  { id: 'ch6', action: 'Background removal ×12', date: '1 Feb 2026', credits: -12 },
]

export const INVOICES = [
  { id: 'INV-2026-0114', date: '11 Feb 2026', amount: 'Rp149.000', status: 'Lunas' },
  { id: 'INV-2026-0089', date: '3 Feb 2026', amount: 'Rp49.000', status: 'Lunas' },
  { id: 'INV-2026-0041', date: '19 Jan 2026', amount: 'Rp149.000', status: 'Lunas' },
]
...
export const MARQUEE_WORDS = [
  'NOIR Atelier', 'Hexworks Games', 'Studio Meridian', 'Argent Collective',
  'Void & Co', 'Monolith Films', 'Aalde Architects', 'Ferraz Brand Studio',
]

/* ─── Landing content: pay-as-you-go credit packages ─── */
...
export const PLANS: CreditPackage[] = [
  {
    id: 'starter', name: 'Starter Pack', price: 49000, credits: 300, bonus: 0, tagline: 'Try it out, no commitment',
    features: ['300 CR · no expiry', 'All engines incl. Motion v1', 'Up to 2K resolution', 'Community gallery', 'Personal projects'],
    cta: 'Top up now', featured: false,
  },
  {
    id: 'creator', name: 'Creator Pack', price: 149000, credits: 1200, bonus: 0, tagline: 'For serious creators',
    features: ['1,200 CR · no expiry', 'All engines incl. Motion v1', 'Up to 4K + upscale', 'Face Swap & BG Removal', 'Creative Resources suite', 'Commercial license', 'Priority queue'],
    cta: 'Top up now', featured: true,
  },
  {
    id: 'studio', name: 'Studio Pack', price: 499000, credits: 4400, bonus: 0, tagline: 'For teams & pipelines',
    features: ['4,400 CR · no expiry', 'Everything in Creator', '5 team seats', 'Module access & premium e-book', 'Brand Kit template + Dedicated support'],
    cta: 'Top up now', featured: false,
  },
]
...
export const FOOTER_COLS = [
  {
    title: 'Product',
    links: ['Features', 'Workflow', 'Showcase', 'Top Up CR', 'API'],
  },
  {
    title: 'Resources',
    links: ['Prompt Library', 'Style Presets', 'Templates', 'Community Gallery'],
  },
  {
    title: 'Company',
...
export const FAQS = [
  ...
  { q: 'How does pay-as-you-go pricing work?', a: 'There is no monthly subscription. You top up CR (credits) once, and they sit in your balance until you use them — no renewal date, no auto-charge. Buy more anytime; unused CR never expires or resets.' },
  { q: 'How many credits does a generation cost?', a: 'Credits are consumed per generation based on engine, resolution and batch size. A 1K image costs 1 CR, 4K costs 4 CR, and video is billed per second of output.' },
  { q: 'Do I own what I create?', a: 'Yes. Every top-up package includes a full commercial license to everything you generate, including image, video and edited assets — free to use in client and commercial work.' },
  { q: 'What happens when my CR balance runs out?', a: 'Generation simply pauses until you top up again. Nothing is charged automatically, and none of your projects, presets or history are affected while your balance is at zero.' },
  { q: 'What payment methods are supported for top-up?', a: 'QRIS, bank transfer, e-wallet (GoPay, OVO, DANA) and major debit/credit cards are all supported for CR top-up.' },
]
