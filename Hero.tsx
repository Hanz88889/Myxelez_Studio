    ...
    <section ref={ref} onMouseMove={onMove} className="relative min-h-screen flex flex-col overflow-hidden pt-32 pb-16">
      ...
      <motion.div style={{ opacity }} className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 w-full">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <Link to="/studio"><motion.button whileTap={{ scale: 0.97 }} className="btn-chrome h-12 px-7 rounded-xl text-sm font-semibold inline-flex items-center gap-2.5 cursor-pointer">Start creating — it's free <ArrowRight size={15} /></motion.button></Link>
